...
client.on('interactionCreate', async interaction => {
    try {
        if (interaction.isChatInputCommand()) {
            if (['drop', 'signal', 'chosen-one', 'sync-circle', 'list', 'pmodif', 'ajuste'].includes(interaction.commandName)) {
